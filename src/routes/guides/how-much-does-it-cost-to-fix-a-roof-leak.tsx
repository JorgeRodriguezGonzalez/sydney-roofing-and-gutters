...
const config: GuideSEOConfig = {
  title: "How Much Does It Cost To Fix A Roof Leak?",
  slug: "how-much-does-it-cost-to-fix-a-roof-leak",
...
const content: GuideContent = {
  ...
  intro: {
    paragraphs: [
      "A roof leak can quickly escalate from a damp patch to mould, rot, and damage to insulation, ceilings and structure. Addressing it early usually keeps costs down and limits harm to your home. In this guide we look at what influences the cost of fixing a roof leak in Australia, typical price ranges, and how to decide between a repair, a roof restoration or a full replacement.",
      "The final cost depends on the cause and location of the leak, the type of roof, ease of access, the extent of hidden damage, and whether other work is needed first. For that reason, ballpark figures are only a starting point. A proper quote requires an on-site inspection by a licensed roofer.",
      "We also outline a simple checklist of steps to take as soon as you notice a leak, and when it makes sense to repair a single defect versus restoring the whole roof or replacing it. Use this as a practical reference; for advice tailored to your property, always get a professional assessment.",
    ],
  },
  quickSummary: {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Urgency and timing: Emergency or after-hours work usually costs more than scheduling during normal business hours. If the leak can be temporarily contained, you may be able to avoid premium call-out fees.",
      ],
      bullets: [
    ...
    },
    {
      ...
      bullets: [
        "Simple localised fixes: often in the low hundreds (e.g. a few hundred dollars); exact amount depends on labour and materials.",
        "Larger or trickier repairs (valleys, multi-tile, complex flashings): mid to high hundreds or more.",
        "Where internal damage, mould or structural work is needed: costs can extend well into the thousands; these are usually quoted separately.",
      ],
    },
    {
      id: "leak-checklist",
      heading: "What to Do When You Notice a Roof Leak",
      paragraphs: [
        "Use this checklist to limit damage and prepare for a professional repair. Do not go onto the roof or into the ceiling if it is unsafe; leave that to licensed tradespeople.",
      ],
      bullets: [
        ...
        "If the leak is severe or you suspect electrical or structural risk, consider turning off power in the affected area and seeking urgent professional help.",
      ],
    },
    {
      id: "repair-restore-replace",
      heading: "Repair, Restoration or Replacement: When to Choose What",
      paragraphs: [
    ...
    },
    {
      ...
      paragraphs: [
        "An accurate price requires an on-site inspection. A roofer needs to see the leak’s cause, the condition of the surrounding roof, and any damage inside the roof space. Descriptions or photos can help with an initial triage, but they cannot replace a physical inspection.",
        "Ask for a written quote that lists: the identified cause of the leak, the exact work to be done (e.g. tiles to replace, flashings, sealing), the materials to be used, and whether the price includes or excludes internal repairs, mould treatment or scaffolding. If the roofer finds additional issues during the job, they should explain them and get your approval before doing extra work. A clear, itemised quote helps you compare offers and avoid unexpected charges.",
      ],
    },
    {
      id: "insurance",
  ...
  testimonial: {
    name: "Nina Park",
    location: "Sydney",
    quote: "We had a leak after heavy rain and weren't sure if it was a quick fix or something bigger. The team identified a failed section of valley and a few cracked tiles. They did the repair first, then suggested a roof restoration for the rest of the roof to prevent more leaks. We went ahead with the restoration and have had no issues since. The quote was clear and the work was done on time.",
    rating: 5,
  },
  cta: {
    heading: "Need a Roof Leak Repair Quote?",
    text: "Get a free, no-obligation inspection and quote from our licensed team. We'll identify the source of the leak, explain the repair options and provide a clear written quote.",
    primaryText: "GET QUOTE",
    primaryHref: "/contact/",
  },
  tags: ["roof leak", "roof repair", "cost guide", "roof restoration", "Sydney"],
