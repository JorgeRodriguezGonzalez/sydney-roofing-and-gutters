...
const generatePostContent = () => `
    ...
    <p class="text-[#666666] leading-relaxed mb-6"><strong>Need professional roofing services with certified safety protocols?</strong> Sydney Roofing & Gutters maintains comprehensive safety standards and certified fall protection systems for all roofing projects throughout the Hunter Region. Our experienced team understands Newcastle's unique safety challenges and provides fully insured services with proper safety equipment. Call us at <a href="tel:1300796024" style="color: #3498DB; text-decoration: none; font-weight: 500;">(02) 4089 4613</a> for professional roofing services, or visit our <a href="/contact-us" style="color: #3498DB; text-decoration: none; font-weight: 500;">contact page</a> to schedule a consultation. For comprehensive safety information, visit our <a href="/roof-inspections" style="color: #3498DB; text-decoration: none; font-weight: 500;">roof inspections page</a> to learn about our professional safety protocols.</p>
`;
    ...
    <div className="min-h-screen flex flex-col bg-white" style={{fontFamily: "'Inter', sans-serif"}}>
      ...
      <SchemaBreadcrumb 
        items={[
          ...
          { name: "Roofing Safety Harness Newcastle: Essential Safety Guide", url: "https://sydneyroofingandgutters.com.au/roofing-safety-harness" }
        ]}
      />
