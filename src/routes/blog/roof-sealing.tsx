    ...
    <div className="min-h-screen flex flex-col bg-white" style={{fontFamily: "'Inter', sans-serif"}}>
      ...
      <SchemaBreadcrumb 
        items={[
          ...
          { name: "Roof Sealing Newcastle: Expert Sealing Services Guide", url: "https://sydneyroofingandgutters.com.au/roof-sealing" }
        ]}
      />
