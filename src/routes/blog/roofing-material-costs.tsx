...
const generatePostContent = () => `
    ...
    <p class="text-[#666666] leading-relaxed mb-6"><strong>Ready to plan your roofing project budget?</strong> Contact Newcastle's trusted roofing experts for comprehensive material cost guidance and professional installation services. Call us at <a href="tel:1300796024" style="color: #3498DB; text-decoration: none; font-weight: 500;">(02) 4089 4613</a> for expert advice, or visit our <a href="/contact-us" style="color: #3498DB; text-decoration: none; font-weight: 500;">contact page</a> to schedule your free consultation and quote. Learn more about our <a href="/roof-replacement" style="color: #3498DB; text-decoration: none; font-weight: 500;">roof replacement services</a> for complete project solutions.</p>
`;
    ...
    <div className="min-h-screen flex flex-col bg-white" style={{fontFamily: "'Inter', sans-serif"}}>
      ...
      <SchemaBreadcrumb 
        items={[
          ...
          { name: "Roofing Material Costs Newcastle: Complete Price Guide 2024", url: "https://sydneyroofingandgutters.com.au/roofing-material-costs" }
        ]}
      />
