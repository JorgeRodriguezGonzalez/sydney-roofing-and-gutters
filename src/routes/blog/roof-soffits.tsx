    ...
    <div className="min-h-screen flex flex-col bg-white" style={{fontFamily: "'Inter', sans-serif"}}>
      ...
      <SchemaBreadcrumb 
        items={[
          ...
          { name: "Roof Soffits Newcastle: Complete Installation & Repair Guide", url: "https://sydneyroofingandgutters.com.au/roof-soffits" }
        ]}
      />
