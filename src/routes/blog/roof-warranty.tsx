    ...
    <div className="min-h-screen flex flex-col bg-white" style={{fontFamily: "'Inter', sans-serif"}}>
      ...
      <SchemaBreadcrumb 
        items={[
          ...
          { name: "Roof Warranty Newcastle: Complete Warranty Guide", url: "https://sydneyroofingandgutters.com.au/roof-warranty" }
        ]}
      />
