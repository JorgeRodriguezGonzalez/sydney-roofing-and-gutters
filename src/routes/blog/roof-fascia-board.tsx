...
const generatePostContent = () => `
    ...
    <p class="text-[#666666] leading-relaxed mb-6"><strong>Need expert fascia board replacement or repair services?</strong> Sydney Roofing & Gutters provides comprehensive fascia solutions throughout the Hunter Region. Our experienced team delivers quality materials and professional installation that withstands Newcastle's challenging coastal environment while enhancing your home's protection and appearance. Call us at <a href="tel:1300796024" style="color: #3498DB; text-decoration: none; font-weight: 500;">(02) 4089 4613</a> for expert assessment, or visit our <a href="/contact-us" style="color: #3498DB; text-decoration: none; font-weight: 500;">contact page</a> to schedule your fascia consultation. Explore our comprehensive roofing services through our <a href="/roof-replacement" style="color: #3498DB; text-decoration: none; font-weight: 500;">roof replacement page</a> for complete roofing system upgrades and protection solutions.</p>
`;
    ...
    <div className="min-h-screen flex flex-col bg-white" style={{fontFamily: "'Inter', sans-serif"}}>
      ...
      <SchemaBreadcrumb 
        items={[
          ...
          { name: "Roof Fascia Board Newcastle: Complete Replacement Guide", url: "https://sydneyroofingandgutters.com.au/roof-fascia-board" }
        ]}
      />
