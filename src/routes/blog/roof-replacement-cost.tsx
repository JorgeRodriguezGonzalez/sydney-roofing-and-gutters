...
const generatePostContent = () => `
    ...
    <p class="text-[#666666] leading-relaxed mb-6"><strong>Planning your Newcastle roof replacement investment?</strong> Sydney Roofing & Gutters provides transparent pricing, competitive quotes, and flexible payment options for comprehensive roof replacement services throughout the Hunter Region. Our experienced team delivers detailed cost breakdowns, quality material selections, and professional installation that maximises your investment value. Call us at <a href="tel:1300796024" style="color: #3498DB; text-decoration: none; font-weight: 500;">(02) 4089 4613</a> for accurate cost assessment, or visit our <a href="/contact-us" style="color: #3498DB; text-decoration: none; font-weight: 500;">contact page</a> to schedule your consultation. Explore our comprehensive <a href="/roof-replacement" style="color: #3498DB; text-decoration: none; font-weight: 500;">roof replacement services</a> to understand how we deliver exceptional value for Newcastle homeowners.</p>
`;
    ...
    <div className="min-h-screen flex flex-col bg-white" style={{fontFamily: "'Inter', sans-serif"}}>
      ...
      <SchemaBreadcrumb 
        items={[
          ...
          { name: "Roof Replacement Cost Newcastle: Complete Price Guide 2024", url: "https://sydneyroofingandgutters.com.au/roof-replacement-cost" }
        ]}
      />
