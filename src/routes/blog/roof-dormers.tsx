    ...
    <div className="min-h-screen flex flex-col bg-white" style={{fontFamily: "'Inter', sans-serif"}}>
      ...
      <SchemaBreadcrumb 
        items={[
          ...
          { name: "Roof Dormers Newcastle: Complete Design & Installation Guide", url: "https://sydneyroofingandgutters.com.au/roof-dormers" }
        ]}
      />
